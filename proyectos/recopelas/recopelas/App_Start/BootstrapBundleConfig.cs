...
[assembly: WebActivatorEx.PostApplicationStartMethod(typeof(recopelas.App_Start.BootstrapBundleConfig), "RegisterBundles")]

namespace recopelas.App_Start
{
	public class BootstrapBundleConfig
	{
		public static void RegisterBundles()
		{
            ...
            BundleTable.Bundles.Add(new StyleBundle("~/Content/recopelas").Include("~/Content/css/style.css"));
